...
export default class Container extends Component {
  ...
  getDragonTreasure() {
    axios.get('/api/treasure/dragon').then(res=> this.setState({treasures: {...this.state.treasures, dragon: res.data}})).catch(err=>console.log('treasure error',err))
  }

  getAllTreasure() {
   axios.get('/api/treasure/all').then(res=>this.setState({treasures: {...this.state.treasures, all: res.data}})).catch(err=> alert(err.response.request.response))
  }

  getMyTreasure() {
    axios.get('/api/treasure/user').then(res=>this.setState({treasures: {...this.state.treasures, user:res.data}})).catch(err=>alert(err.response.request.response))
  }
